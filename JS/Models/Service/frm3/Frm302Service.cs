...
public class Frm302Service 
{
    ...
    public JObject getDG1(String yrn)
    {
        ...
        */
        String sql = "select a.CNO,a.CNM,a.TP,ISNULL(b.YRN,'"+yrn+"') as YRN,b.ACCNO,b.ACCTP,ISNULL(b.BUDGET,0) as BUDGET,ISNULL(b.USEAMT,0) as USEAMT,b.TAGID from V_ACCF as a " +
                    "LEFT JOIN (select * from ACCBUDGET where yrn='"+yrn+"') as b "+
                    " on a.CNO=b.ACCNO and a.TP=b.ACCTP";

        var query = db.Database.SqlQuery<tmp>(sql);
...
and a.ACCTP =b.TP
    ...
    public int doSave(Frm302Poco param, String isSplit)
    {
    ...
    public int doAdd(Frm302Poco param)
    {
...
String sql ="select a.CNO,a.CNM,a.TP, "+
            "isnull((select b.BUDGET from YMBUDGET as b where b.YM='"+YY+"'  + '01' and b.ACCNO=a.CNO and b.ACCTP=a.TP ),0) as m1,"+
            "isnull((select b.BUDGET from YMBUDGET as b where b.YM='"+YY+"'  + '02' and b.ACCNO=a.CNO and b.ACCTP=a.TP ),0) as m2,"+
            "isnull((select b.BUDGET from YMBUDGET as b where b.YM='"+YY+"'  + '03' and b.ACCNO=a.CNO and b.ACCTP=a.TP ),0) as m3,"+
            "isnull((select b.BUDGET from YMBUDGET as b where b.YM='"+YY+"'  + '04' and b.ACCNO=a.CNO and b.ACCTP=a.TP ),0) as m4,"+
            "isnull((select b.BUDGET from YMBUDGET as b where b.YM='"+YY+"'  + '05' and b.ACCNO=a.CNO and b.ACCTP=a.TP ),0) as m5,"+
            "isnull((select b.BUDGET from YMBUDGET as b where b.YM='"+YY+"'  + '06' and b.ACCNO=a.CNO and b.ACCTP=a.TP ),0) as m6,"+
            "isnull((select b.BUDGET from YMBUDGET as b where b.YM='"+YY+"'  + '07' and b.ACCNO=a.CNO and b.ACCTP=a.TP ),0) as m7,"+
            "isnull((select b.BUDGET from YMBUDGET as b where b.YM='"+YY+"'  + '08' and b.ACCNO=a.CNO and b.ACCTP=a.TP ),0) as m8,"+
            "isnull((select b.BUDGET from YMBUDGET as b where b.YM='"+YY+"'  + '09' and b.ACCNO=a.CNO and b.ACCTP=a.TP ),0) as m9,"+
            "isnull((select b.BUDGET from YMBUDGET as b where b.YM='"+YY+"'  + '10' and b.ACCNO=a.CNO and b.ACCTP=a.TP ),0) as m10,"+
            "isnull((select b.BUDGET from YMBUDGET as b where b.YM='"+YY+"'  + '11' and b.ACCNO=a.CNO and b.ACCTP=a.TP ),0) as m11,"+
            "isnull((select b.BUDGET from YMBUDGET as b where b.YM='"+YY+"'  + '12' and b.ACCNO=a.CNO and b.ACCTP=a.TP ),0) as m12,"+
            "isnull(c.USEAMT,0) as USEAMT,"+
            "isnull(c.BUDGET,0) as BUDGET "+
            "from V_ACCF as a "+
        ...
        var query = db.Database.SqlQuery<tmp2>(sql);
        foreach (var item in query)
        {
            var itemObject = new JObject
                    {   
