...
using HowardCoupon_vs2010.Filters;
using HowardCoupon_vs2010.Models;
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            if (User.Identity.IsAuthenticated)
            {
              ...
              else
              {
                  ...
                  LoginProcess( userid, model.RememberMe);
                  return RedirectToAction("Index", "Home");
              }
        }


        private void LoginProcess(String userid, bool isRemeber)
        {
